#! /bin/bash
# Any Post-task items can be accomplished from this BASH script.
...
#   -f ~/newproject/nbs4j_test_jms_framework/testcases/raw_definition/testcase1_example/clean_up.txt -np
